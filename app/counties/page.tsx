...
function CountiesContent() {
  const [items, setItems] = useState<County[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-2">County Explorer</h1>
        <p className="text-gray-600 mb-6">Employment permit issuance by county (Issued permits).</p>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={2} className="px-6 py-12 text-center text-gray-500">No counties found</td>
                  </tr>
                ) : (
                  items.map((item, idx) => (
